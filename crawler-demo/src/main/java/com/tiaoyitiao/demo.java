...
///sdcard/current.png
	...
	// 按压的时间系数，可根据具体情况适当调节  1.35
	private final double pressTimeCoefficient = 2.05;

	// 按压的起始点坐标，也是再来一局的起始点坐标 550
	private final int swipeX = 450;
	//1580
	private final int swipeY = 980;
	...
	private void executeCommand(String command) {
		...
		try {
			process = Runtime.getRuntime().exec(command);// cmd /c
